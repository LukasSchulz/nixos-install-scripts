...
#       curl -L https://raw.githubusercontent.com/LukasSchulz/nixos-install-scripts/master/hosters/hetzner-cloud/nixos-install-hetzner-cloud.sh | sudo bash
#
...
echo '
  ...
  users.users.root.openssh.authorizedKeys.keys = [
    ...
    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN2SA6gC3tGLC5tsh6KN+UZ52wjPlgw5kAV2ZzHwatFS ausgeschwurbelt"
  ];
}
